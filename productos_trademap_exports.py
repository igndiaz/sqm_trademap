...
try:
    with open("/home/sqm_repositorio_gcp/app/secrets/trademap_1.json", "r", encoding="UTF-8") as json_file:
...
txt_productos = "/home/sqm_repositorio_gcp/app/variables_sitios/productos.txt"
productos = []
...
# intenta acceder a directorio trademap_productos_exp, si no existe lo crea
try:
    os.chdir("trademap_productos_exp")
except FileNotFoundError:
    os.mkdir("trademap_productos_exp")
    print("No existía directorio 'trademap_productos_exp', creado nuevo directorio output/trademap_productos_exp")
    os.chdir("trademap_productos_exp")
except:
    print("Se encontró un error al tratar de entrar a output/trademap_productos_exp, no pudo ser creado tampoco. Se muestra error a continuación: \n)")
    raise
