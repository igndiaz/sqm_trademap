...
try:
    with open("/home/sqm_repositorio_gcp/app/secrets/trademap_3.json", "r", encoding="UTF-8") as json_file:
    ...
    print("No se ha podido leer el archivo de credenciales, revise tenerlo en 'secrets/trademap_exports.json'\n")
except:
...
txt_productos = "/home/sqm_repositorio_gcp/app/variables_sitios/productos_cultivos.txt"
productos = []
...
txt_paises = "/home/sqm_repositorio_gcp/app/variables_sitios/paises.txt"
paises = []
...
directorio = "/home/sqm_repositorio_gcp/app"
os.chdir("..")
...
# intenta acceder a directorio trademap_cultivos_exp, si no existe lo crea
try:
    os.chdir("trademap_cultivos_exp")
except FileNotFoundError:
    os.mkdir("trademap_cultivos_exp")
    print("No existía directorio 'trademap_cultivos_exp', creado nuevo directorio output/trademap_cultivos_exp")
    os.chdir("trademap_cultivos_exp")
except:
    print("Se encontró un error al tratar de entrar a output/trademap_cultivos_exp, no pudo ser creado tampoco. Se muestra error a continuación: \n)")
    raise
...
def exportaciones(producto, pais):
    ...
    time.sleep(2)
    print(str(get_time()) + " se ejecuta proceso para exports de " + str(pais))
    exports_button = driver.find_element_by_id('ctl00_PageContent_label_RadioButton_TradeType_Export')
    imports_button = driver.find_element_by_id('ctl00_PageContent_RadioButton_TradeType_Import')
    
    print(str(get_time()) + " boton exports")
    ...
    try:
        ...
        [cat.click() for cat in select_category.options if "Exports" in cat.text]
        print("Confirmado Exports")
        time.sleep(2)
    except:
        print("Asegurado Exports")
...
union_no_duplicates.to_csv("trademap_export_cultivos.csv")
upload_blob("sqm_trademap_cultivos_exports","trademap_export_cultivos.csv","trademap_export_cultivos.csv")
...
# Exportación a formato Excel de tabla de buenos:
#union_no_duplicates.to_excel("../output_imports.xlsx")
union_no_duplicates.to_excel("trademap_export_cultivos.xlsx")
